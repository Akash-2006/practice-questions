...
const multiplication = function (multiplicand, multiplier) {
...
const averageOf = function (numbers) {
  return numbers.reduce(addition, 0) / numbers.length;
};

// minOf([3, 1, 4, 1, 5, 9, 2]) => 1
const getSmallestElement = function (element1, element2) {
  return element1 < element2 ? element1 : element2;
};

const minOf = function (numbers) {
  return numbers.reduce(getSmallestElement, Infinity);
};

console.log(minOf([3, 1, 4, 1, 5, 9, 2]));

// maxOf([3, 1, 4, 1, 5, 9, 2]) => 9
const getLargestElement = function (element1, element2) {
  return element1 > element2 ? element1 : element2;
};

const maxOf = function (numbers) {
  return numbers.reduce(getLargestElement, -Infinity);
};
...
const sumPositiveNumbers = function (numbers) {
  return numbers.filter(isPositive).reduce(addition, 0);
};
